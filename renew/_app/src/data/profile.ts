...
export const profile: ProfileData = {
  ...
  company: "Gabia",
  tagline:
    "웹표준과 접근성을 지키면서도, 오늘의 도구로 더 나은 경험을 만드는 일에 집중합니다.",
  bio: [
    "2009년 디지털 에이전시 UBER에서 프론트엔드 개발자로 커리어를 시작해, 2014년부터 현재까지 가비아(Gabia)의 프론트엔드 개발팀에 몸담고 있습니다.",
  ...
  highlights: [
    "프론트엔드 개발자 · UBER(2009–2013) → Gabia(2014–현재)",
